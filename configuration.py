...
def main(page: ft.Page):
    ...
    txt_mqtt_broker = ft.TextField(label="MQTT Broker IP", value=config_data.get("mqtt_broker", ""))
    txt_mqtt_port = ft.TextField(label="MQTT Port", value=str(config_data.get("mqtt_port", "")))
    ...
    def on_save(e):
        try:
            ...
            config_data["mqtt_broker"] = txt_mqtt_broker.value
            config_data["mqtt_port"] = int(txt_mqtt_port.value)
