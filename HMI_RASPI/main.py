...
def main(page: ft.Page):
    ...
    page.window.frameless = (
        True  # menghilangkan border dan title bar pada jendela aplikasi
    )
    ...
    def show_list_pinjaman_user():
        ...
        btn_action = create_filled_button(
            "Lanjut scan alat",
            "#1F2937",
            lambda _: show_scan_kembali(borrowed) if borrowed else None,
            width=450,
            height=50,
            disabled=not bool(borrowed),
        )
        main_card = ft.Container(
            content=ft.Column(
                [
        ...
        page.add(
            build_standard_layout(
                ft.Column(
                    [main_card], horizontal_alignment="center", alignment="center"
                ),
    ...
    def show_scan_tag_alat(tool_name):
        ...
        page.add(
            build_standard_layout(
                ...
                back_func=lambda e: keluar_halaman(show_home),
            )
        )
        import threading
    ...
    def show_position_selection(name, data):
        ...
        page.add(
            build_standard_layout(
                ...
                back_func=show_peminjaman_page1,
            )
        )
